...
class Auth extends ShieldAuth
{
    ...
    public array $redirects = [
        'register'          => '/',      // Redirige vers l'accueil après inscription
        'login'             => '/',      // Redirige vers l'accueil après connexion
        'logout'            => 'login',  // Redirige vers la page de login après déconnexion
        'force_reset'       => '/',
        'permission_denied' => '/',
        'group_denied'      => '/',
    ];
